...
import closetDoorGLB from './glb/smallClosetDoor.glb';


const RapierWorldSmallClosetDoor = () => {
  ...
  const rotation = new Euler(MathUtils.degToRad(270), -MathUtils.degToRad(180), MathUtils.degToRad(90));
  const secondRotation = new Euler(MathUtils.degToRad(90), -MathUtils.degToRad(180), MathUtils.degToRad(90));
  ...
  useEffect(() => {
    gsap.to(ClosetDoorRef.current.rotation, {
      ...
      z: isFirstDoorOpen ? MathUtils.degToRad(180) : MathUtils.degToRad(90),
      ease: 'power2.inOut',
    });
  }, [isFirstDoorOpen]);
  ...
  useEffect(() => {
    gsap.to(secondClosetDoorRef.current.rotation, {
      duration: 1,
      delay: 0.1, // introduce a delay
      z: isSecondDoorOpen ? MathUtils.degToRad(180) : MathUtils.degToRad(90),
      ease: 'power2.inOut',
    });
  }, [isSecondDoorOpen]);
...
export { RapierWorldSmallClosetDoor };
